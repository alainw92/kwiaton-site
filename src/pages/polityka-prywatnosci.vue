<template>
	<main>
		<h1 class="text-h4 mb-6 ml-4">Polityka prywatności</h1>
		<v-row>
			<v-col>
				<card class="pa-8">
					<article class="text-justify">
						<h2 class="text-h5 mb-6 text-indent">Polityka prywatności opisuje zasady przetwarzania przez nas informacji na Twój temat, w tym danych osobowych oraz ciasteczek, czyli tzw. &laquo;cookies&raquo;.</h2>

						<h3 class="text-h6">1. Informacje ogólne</h3>

						<p>Niniejsza polityka dotyczy Serwisu www, funkcjonującego pod adresem url: www.kwiaton-sztukatorstwo.com.pl</p>
						<p>Operatorem serwisu oraz Administratorem danych osobowych jest: ZPUH Kwiaton Pracownia Sztukatorska Wiesław Kwiatkowski, ul. Cicha 32A, 36-040, Boguchwała.</p>
						<p>Adres kontaktowy poczty elektronicznej operatora: &#105;&#110;&#102;&#111;&#064;&#107;&#119;&#105;&#097;&#116;&#111;&#110;&#045;&#115;&#122;&#116;&#117;&#107;&#097;&#116;&#111;&#114;&#115;&#116;&#119;&#111;&#046;&#099;&#111;&#109;&#046;&#112;&#108;</p>
						...
						<h3 class="text-h6">2. Wybrane metody ochrony danych stosowane przez Operatora</h3>
						...
						<h3 class="text-h6">3. Hosting</h3>

						<p>Serwis jest hostowany (technicznie utrzymywany) na serwerach operatora: cyberfolks.pl</p>

						<h3 class="text-h6">4. Twoje prawa i dodatkowe informacje o sposobie wykorzystania danych</h3>
						...
						<p>Przysługuje Ci prawo do złożenia sprzeciwu w zakresie przetwarzania danych osobowych w celu wykonania prawnie uzasadnionych interesów realizowanych przez Administratora, w tym profilowania, przy czym prawo sprzeciwu nie będzie mogło być wykonane w przypadku istnienia ważnych prawnie uzasadnionych podstaw do przetwarzania, nadrzędnych wobec Ciebie interesów, praw i wolności, w szczególności ustalenia, dochodzenia lub obrony roszczeń.</p>
						...
						<h3 class="text-h6">5. Informacje w formularzach</h3>
						...
						<h3 class="text-h6">6. Logi Administratora</h3>
						...
						<h3 class="text-h6">7. Istotne techniki marketingowe</h3>
						...
						<p>
							...
							<a
								...
								target="_blank"
							>https://www.google.com/ads/preferences/</a>
						</p>

						<h3 class="text-h6">8. Informacja o plikach cookies</h3>
						...
						<ul>
							<li>zapisanie preferencji językowych Użytkownika - na czas 1 roku;</li>
							<li>realizacji celów określonych powyżej w części "Istotne techniki marketingowe";</li>
						</ul>
						<p>W ramach Serwisu stosowany jest jeden zasadniczy rodzaj plików cookies: „stały” (persistent cookies). „Stałe” pliki cookies przechowywane są w urządzeniu końcowym Użytkownika przez czas określony w parametrach plików cookies lub do czasu ich usunięcia przez Użytkownika.</p>
						...
						<p>Pliki cookies zamieszczane w urządzeniu końcowym Użytkownika Serwisu wykorzystywane mogą być również przez współpracujące z operatorem Serwisu podmioty, w szczególności dotyczy to firm: Google (Google Inc. z siedzibą w USA).</p>

						<h3 class="text-h6">9. Zarządzanie plikami cookies – jak w praktyce wyrażać i cofać zgodę?</h3>
						...
						<ul>
							...
							<li>
								<a href="http://help.opera.com/Windows/12.10/pl/cookies.html" target="_blank">Opera</a>
							</li>
						</ul>
						...
						<ul>
							...
							<li>
								<a href="http://support.apple.com/kb/HT1677?viewlocale=pl_PL" target="_blank">Safari (iOS)</a>
							</li>
							<li>
								<a
