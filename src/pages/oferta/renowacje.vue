<template>
  <section class="pa-4">
		<h2 class="text-h5 mb-6">Renowacje budynków</h2>
		<p>Zajmujemy się renowacjami zabytkowych budynków wraz z odtworzeniem wszystkich detali architektonicznych.</p>
